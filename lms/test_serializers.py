...
class LessonSerializerTestCase(APITestCase):
    ...
    def test_invalid_url(self):
        ...
        self.assertIn(
            "video", serializer.errors
        )  # Проверяем, что поле 'video' содержит ошибки
        self.assertEqual(
            serializer.errors["video"][0],
            "Вам разрешено добавлять ссылки только с youtube.com или youtu.be",
        )
