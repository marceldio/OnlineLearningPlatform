...
class Payment(models.Model):
    ...
    paid_course = models.ForeignKey(Course, verbose_name="Оплаченный курс", on_delete=models.CASCADE, blank=True, null=True)
    paid_lesson = models.ForeignKey(Lesson, verbose_name="Оплаченный урок", on_delete=models.CASCADE, blank=True, null=True)
